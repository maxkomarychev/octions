...
1. [Revoke a grant for an application](./octions/oauth-authorizations/revoke-grant-for-application/README.md)
1. [Check an authorization](./octions/oauth-authorizations/check-authorization/README.md)
1. [Reset an authorization](./octions/oauth-authorizations/reset-authorization/README.md)
1. [Revoke an authorization for an application](./octions/oauth-authorizations/revoke-authorization-for-application/README.md)
