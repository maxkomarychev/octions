...
1. [Revoke an installation token](./octions/apps/revoke-installation-token/README.md)
1. [Get a subscription plan for an account](./octions/apps/get-subscription-plan-for-account/README.md)
1. [List plans](./octions/apps/list-plans/README.md)
1. [List accounts for a plan](./octions/apps/list-accounts-for-plan/README.md)
1. [Get a subscription plan for an account (stubbed)](./octions/apps/get-subscription-plan-for-account-stubbed/README.md)
1. [List plans (stubbed)](./octions/apps/list-plans-stubbed/README.md)
1. [List accounts for a plan (stubbed)](./octions/apps/list-accounts-for-plan-stubbed/README.md)
...
1. [List subscriptions for the authenticated user](./octions/apps/list-subscriptions-for-authenticated-user/README.md)
1. [List subscriptions for the authenticated user (stubbed)](./octions/apps/list-subscriptions-for-authenticated-user-stubbed/README.md)
...
1. [List all codes of conduct](./octions/codes-of-conduct/get-all-codes-of-conduct/README.md)
...
1. [Get feeds](./octions/activity/get-feeds/README.md)
1. [List public events for a network of repositories](./octions/activity/list-public-events-for-repo-network/README.md)
1. [List notifications for the authenticated user](./octions/activity/list-notifications-for-authenticated-user/README.md)
1. [Mark notifications as read](./octions/activity/mark-notifications-as-read/README.md)
1. [Get a thread](./octions/activity/get-thread/README.md)
1. [Mark a thread as read](./octions/activity/mark-thread-as-read/README.md)
1. [Get a thread subscription for the authenticated user](./octions/activity/get-thread-subscription-for-authenticated-user/README.md)
...
1. [List public organization events](./octions/activity/list-public-org-events/README.md)
1. [List repository events](./octions/activity/list-repo-events/README.md)
1. [List repository notifications for the authenticated user](./octions/activity/list-repo-notifications-for-authenticated-user/README.md)
1. [Mark repository notifications as read](./octions/activity/mark-repo-notifications-as-read/README.md)
...
1. [List repositories starred by the authenticated user](./octions/activity/list-repos-starred-by-authenticated-user/README.md)
1. [Check if a repository is starred by the authenticated user](./octions/activity/check-repo-is-starred-by-authenticated-user/README.md)
1. [Star a repository for the authenticated user](./octions/activity/star-repo-for-authenticated-user/README.md)
1. [Unstar a repository for the authenticated user](./octions/activity/unstar-repo-for-authenticated-user/README.md)
1. [List repositories watched by the authenticated user](./octions/activity/list-watched-repos-for-authenticated-user/README.md)
...
1. [List events for the authenticated user](./octions/activity/list-events-for-authenticated-user/README.md)
1. [List organization events for the authenticated user](./octions/activity/list-org-events-for-authenticated-user/README.md)
1. [List public events for a user](./octions/activity/list-public-events-for-user/README.md)
1. [List events received by the authenticated user](./octions/activity/list-received-events-for-user/README.md)
1. [List public events received by a user](./octions/activity/list-received-public-events-for-user/README.md)
1. [List repositories starred by a user](./octions/activity/list-repos-starred-by-user/README.md)
1. [List repositories watched by a user](./octions/activity/list-repos-watched-by-user/README.md)

## GISTS

1. [List gists for the authenticated user](./octions/gists/list/README.md)
1. [Create a gist](./octions/gists/create/README.md)
1. [List public gists](./octions/gists/list-public/README.md)
1. [List starred gists](./octions/gists/list-starred/README.md)
1. [Get a gist](./octions/gists/get/README.md)
1. [Update a gist](./octions/gists/update/README.md)
...
1. [List gists for a user](./octions/gists/list-for-user/README.md)
...
1. [List issues assigned to the authenticated user](./octions/issues/list/README.md)
1. [List organization issues assigned to the authenticated user](./octions/issues/list-for-org/README.md)
1. [List assignees](./octions/issues/list-assignees/README.md)
1. [Check assignee](./octions/issues/check-assignee/README.md)
1. [List repository issues](./octions/issues/list-for-repo/README.md)
...
1. [Get an issue](./octions/issues/get/README.md)
1. [Update an issue](./octions/issues/update/README.md)
...
1. [Replace all labels for an issue](./octions/issues/replace-all-labels/README.md)
1. [Remove all labels from an issue](./octions/issues/remove-all-labels/README.md)
...
1. [List user account issues assigned to the authenticated user](./octions/issues/list-for-authenticated-user/README.md)
...
1. [Download an organization migration archive](./octions/migrations/download-archive-for-org/README.md)
...
1. [Create an organization repository](./octions/repos/create-in-org/README.md)
1. [Get a repository](./octions/repos/get/README.md)
1. [Update a repository](./octions/repos/update/README.md)
...
1. [Delete a deployment](./octions/repos/delete-deployment/README.md)
...
1. [Upload a release asset](./octions/repos/upload-release-asset/README.md)
...
1. [Get all repository topics](./octions/repos/get-all-topics/README.md)
1. [Replace all repository topics](./octions/repos/replace-all-topics/README.md)
...
1. [Create a repository using a template](./octions/repos/create-using-template/README.md)
1. [List public repositories](./octions/repos/list-public/README.md)
1. [List repositories for the authenticated user](./octions/repos/list-for-authenticated-user/README.md)
1. [Create a repository for the authenticated user](./octions/repos/create-for-authenticated-user/README.md)
...
1. [List repositories for a user](./octions/repos/list-for-user/README.md)
...
1. [Edit team](./octions/teams/update-in-org/README.md)
1. [Delete team](./octions/teams/delete-in-org/README.md)
1. [List discussions](./octions/teams/list-discussions-in-org/README.md)
1. [Create a discussion](./octions/teams/create-discussion-in-org/README.md)
1. [Get a single discussion](./octions/teams/get-discussion-in-org/README.md)
1. [Edit a discussion](./octions/teams/update-discussion-in-org/README.md)
1. [Delete a discussion](./octions/teams/delete-discussion-in-org/README.md)
1. [List comments](./octions/teams/list-discussion-comments-in-org/README.md)
1. [Create a comment](./octions/teams/create-discussion-comment-in-org/README.md)
1. [Get a single comment](./octions/teams/get-discussion-comment-in-org/README.md)
1. [Edit a comment](./octions/teams/update-discussion-comment-in-org/README.md)
1. [Delete a comment](./octions/teams/delete-discussion-comment-in-org/README.md)
1. [List pending team invitations](./octions/teams/list-pending-invitations-in-org/README.md)
1. [List team members](./octions/teams/list-members-in-org/README.md)
1. [Get team membership](./octions/teams/get-membership-in-org/README.md)
1. [Add or update team membership](./octions/teams/add-or-update-membership-in-org/README.md)
1. [Remove team membership](./octions/teams/remove-membership-in-org/README.md)
1. [List team projects](./octions/teams/list-projects-in-org/README.md)
1. [Review a team project](./octions/teams/review-project-in-org/README.md)
1. [Add or update team project](./octions/teams/add-or-update-project-in-org/README.md)
1. [Remove team project](./octions/teams/remove-project-in-org/README.md)
1. [List team repos](./octions/teams/list-repos-in-org/README.md)
1. [Check if a team manages a repository](./octions/teams/check-manages-repo-in-org/README.md)
1. [Add or update team repository](./octions/teams/add-or-update-repo-in-org/README.md)
1. [Remove team repository](./octions/teams/remove-repo-in-org/README.md)
1. [List IdP groups for a team](./octions/teams/list-id-p-groups-in-org/README.md)
1. [Create or update IdP group connections](./octions/teams/create-or-update-id-p-group-connections-in-org/README.md)
1. [List child teams](./octions/teams/list-child-in-org/README.md)
1. [Get team (Legacy)](./octions/teams/get-legacy/README.md)
1. [Edit team (Legacy)](./octions/teams/update-legacy/README.md)
1. [Delete team (Legacy)](./octions/teams/delete-legacy/README.md)
1. [List discussions (Legacy)](./octions/teams/list-discussions-legacy/README.md)
1. [Create a discussion (Legacy)](./octions/teams/create-discussion-legacy/README.md)
1. [Get a single discussion (Legacy)](./octions/teams/get-discussion-legacy/README.md)
1. [Edit a discussion (Legacy)](./octions/teams/update-discussion-legacy/README.md)
1. [Delete a discussion (Legacy)](./octions/teams/delete-discussion-legacy/README.md)
1. [List comments (Legacy)](./octions/teams/list-discussion-comments-legacy/README.md)
1. [Create a comment (Legacy)](./octions/teams/create-discussion-comment-legacy/README.md)
1. [Get a single comment (Legacy)](./octions/teams/get-discussion-comment-legacy/README.md)
1. [Edit a comment (Legacy)](./octions/teams/update-discussion-comment-legacy/README.md)
1. [Delete a comment (Legacy)](./octions/teams/delete-discussion-comment-legacy/README.md)
1. [List pending team invitations (Legacy)](./octions/teams/list-pending-invitations-legacy/README.md)
1. [List team members (Legacy)](./octions/teams/list-members-legacy/README.md)
1. [Get team member (Legacy)](./octions/teams/get-member-legacy/README.md)
1. [Add team member (Legacy)](./octions/teams/add-member-legacy/README.md)
1. [Remove team member (Legacy)](./octions/teams/remove-member-legacy/README.md)
1. [Get team membership (Legacy)](./octions/teams/get-membership-legacy/README.md)
1. [Add or update team membership (Legacy)](./octions/teams/add-or-update-membership-legacy/README.md)
1. [Remove team membership (Legacy)](./octions/teams/remove-membership-legacy/README.md)
1. [List team projects (Legacy)](./octions/teams/list-projects-legacy/README.md)
1. [Review a team project (Legacy)](./octions/teams/review-project-legacy/README.md)
1. [Add or update team project (Legacy)](./octions/teams/add-or-update-project-legacy/README.md)
1. [Remove team project (Legacy)](./octions/teams/remove-project-legacy/README.md)
1. [List team repos (Legacy)](./octions/teams/list-repos-legacy/README.md)
1. [Check if a team manages a repository (Legacy)](./octions/teams/check-manages-repo-legacy/README.md)
1. [Add or update team repository (Legacy)](./octions/teams/add-or-update-repo-legacy/README.md)
1. [Remove team repository (Legacy)](./octions/teams/remove-repo-legacy/README.md)
1. [List IdP groups for a team (Legacy)](./octions/teams/list-id-p-groups-for-legacy/README.md)
1. [Create or update IdP group connections (Legacy)](./octions/teams/create-or-update-id-p-group-connections-legacy/README.md)
1. [List child teams (Legacy)](./octions/teams/list-child-legacy/README.md)
1. [List user teams](./octions/teams/list-for-authenticated-user/README.md)

## REACTIONS

1. [List reactions for a team discussion comment](./octions/reactions/list-for-team-discussion-comment-in-org/README.md)
1. [Create reaction for a team discussion comment](./octions/reactions/create-for-team-discussion-comment-in-org/README.md)
1. [Delete team discussion comment reaction](./octions/reactions/delete-for-team-discussion-comment/README.md)
1. [List reactions for a team discussion](./octions/reactions/list-for-team-discussion-in-org/README.md)
1. [Create reaction for a team discussion](./octions/reactions/create-for-team-discussion-in-org/README.md)
1. [Delete team discussion reaction](./octions/reactions/delete-for-team-discussion/README.md)
1. [Delete a reaction (Legacy)](./octions/reactions/delete-legacy/README.md)
...
1. [Delete a commit comment reaction](./octions/reactions/delete-for-commit-comment/README.md)
...
1. [Delete an issue comment reaction](./octions/reactions/delete-for-issue-comment/README.md)
...
1. [Delete an issue reaction](./octions/reactions/delete-for-issue/README.md)
...
1. [Delete a pull request comment reaction](./octions/reactions/delete-for-pull-request-comment/README.md)
1. [List reactions for a team discussion comment (Legacy)](./octions/reactions/list-for-team-discussion-comment-legacy/README.md)
1. [Create reaction for a team discussion comment (Legacy)](./octions/reactions/create-for-team-discussion-comment-legacy/README.md)
1. [List reactions for a team discussion (Legacy)](./octions/reactions/list-for-team-discussion-legacy/README.md)
1. [Create reaction for a team discussion (Legacy)](./octions/reactions/create-for-team-discussion-legacy/README.md)
...
1. [Get a check run](./octions/checks/get/README.md)
1. [List check run annotations](./octions/checks/list-annotations/README.md)
1. [Create a check suite](./octions/checks/create-suite/README.md)
1. [Update repository preferences for check suites](./octions/checks/set-suites-preferences/README.md)
1. [Get a check suite](./octions/checks/get-suite/README.md)
...
1. [List followers of the authenticated user](./octions/users/list-followers-for-authenticated-user/README.md)
1. [List users followed by the authenticated user](./octions/users/list-followed-by-authenticated/README.md)
...
1. [List followers of a user](./octions/users/list-followers-for-user/README.md)
1. [List users followed by another user](./octions/users/list-following-for-user/README.md)
