...
Original documentation: https://developer.github.com/v3/apps/marketplace/#get-a-users-marketplace-purchases
...
```yaml
- uses: maxkomarychev/octions/octions/apps/list-marketplace-purchases-for-authenticated-user-stubbed@master
  id: my_step_id
  with:
    token: <token value>
