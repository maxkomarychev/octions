...
Original documentation: https://developer.github.com/v3/apps/oauth_applications/#revoke-an-authorization-for-an-application
...
```yaml
- uses: maxkomarychev/octions/octions/apps/revoke-authorization-for-application@master
  id: my_step_id
  with:
    token: <token value>
