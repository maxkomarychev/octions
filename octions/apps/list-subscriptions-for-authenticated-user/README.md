...
Original documentation: https://developer.github.com/v3/apps/marketplace/#list-subscriptions-for-the-authenticated-user
...
```yaml
- uses: maxkomarychev/octions/octions/apps/list-subscriptions-for-authenticated-user@master
  id: my_step_id
  with:
    token: <token value>
