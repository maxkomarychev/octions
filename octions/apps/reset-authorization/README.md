...
Original documentation: https://developer.github.com/v3/apps/oauth_applications/#reset-an-authorization
...
```yaml
- uses: maxkomarychev/octions/octions/apps/reset-authorization@master
  id: my_step_id
  with:
    token: <token value>
