...
Original documentation: https://developer.github.com/v3/apps/marketplace/#list-subscriptions-for-the-authenticated-user-stubbed
...
```yaml
- uses: maxkomarychev/octions/octions/apps/list-subscriptions-for-authenticated-user-stubbed@master
  id: my_step_id
  with:
    token: <token value>
