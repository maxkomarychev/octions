...
Original documentation: https://developer.github.com/v3/apps/marketplace/#list-accounts-for-a-plan-stubbed
...
```yaml
- uses: maxkomarychev/octions/octions/apps/list-accounts-for-plan-stubbed@master
  id: my_step_id
  with:
    token: <token value>
