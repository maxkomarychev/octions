...
Original documentation: https://developer.github.com/v3/repos/#replace-all-repository-topics
...
```yaml
- uses: maxkomarychev/octions/octions/repos/replace-all-topics@master
  id: my_step_id
  with:
    token: <token value>
    names: <names value>
