...
Original documentation: https://developer.github.com/v3/repos/#list-repositories-for-the-authenticated-user
...
```yaml
- uses: maxkomarychev/octions/octions/repos/list-for-authenticated-user@master
  id: my_step_id
  with:
    token: <token value>
