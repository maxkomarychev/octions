...
Original documentation: https://developer.github.com/v3/repos/#enable-automated-security-fixes
...
```yaml
- uses: maxkomarychev/octions/octions/repos/enable-automated-security-fixes@master
  id: my_step_id
  with:
    token: <token value>
    owner: <owner value>
