...
Original documentation: https://developer.github.com/v3/reactions/#delete-an-issue-comment-reaction
...
```yaml
- uses: maxkomarychev/octions/octions/reactions/delete-for-issue-comment@master
  id: my_step_id
  with:
    token: <token value>
