...
Original documentation: https://developer.github.com/v3/reactions/#list-reactions-for-a-team-discussion

This action implements `GET` request to `/teams/{team_id}/discussions/{discussion_number}/reactions`
