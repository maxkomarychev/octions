...
Original documentation: https://developer.github.com/v3/reactions/#delete-a-pull-request-comment-reaction
...
```yaml
- uses: maxkomarychev/octions/octions/reactions/delete-for-pull-request-comment@master
  id: my_step_id
  with:
    token: <token value>
