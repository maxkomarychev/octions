...
Original documentation: https://developer.github.com/v3/reactions/#delete-an-issue-reaction
...
```yaml
- uses: maxkomarychev/octions/octions/reactions/delete-for-issue@master
  id: my_step_id
  with:
    token: <token value>
