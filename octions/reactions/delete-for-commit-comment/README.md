...
Original documentation: https://developer.github.com/v3/reactions/#delete-a-commit-comment-reaction
...
```yaml
- uses: maxkomarychev/octions/octions/reactions/delete-for-commit-comment@master
  id: my_step_id
  with:
    token: <token value>
