...
Original documentation: https://developer.github.com/v3/reactions/#delete-team-discussion-comment-reaction
...
```yaml
- uses: maxkomarychev/octions/octions/reactions/delete-for-team-discussion-comment@master
  id: my_step_id
  with:
    token: <token value>
    org: <org value>
