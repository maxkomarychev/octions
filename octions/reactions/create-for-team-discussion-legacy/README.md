...
Original documentation: https://developer.github.com/v3/reactions/#create-reaction-for-a-team-discussion-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/reactions/create-for-team-discussion-legacy@master
  id: my_step_id
  with:
    token: <token value>
