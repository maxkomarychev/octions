...
Original documentation: https://developer.github.com/v3/actions/secrets/#list-secrets-for-a-repository
...
```yaml
- uses: maxkomarychev/octions/octions/actions/list-secrets-for-repo@master
  id: my_step_id
  with:
    token: <token value>
