...
Original documentation: https://developer.github.com/v3/actions/self_hosted_runners/#create-a-registration-token
...
```yaml
- uses: maxkomarychev/octions/octions/actions/create-registration-token@master
  id: my_step_id
  with:
    token: <token value>
- name: Print outputs
