...
Original documentation: https://developer.github.com/v3/actions/self_hosted_runners/#get-a-self-hosted-runner
...
```yaml
- uses: maxkomarychev/octions/octions/actions/get-self-hosted-runner@master
  id: my_step_id
  with:
    token: <token value>
