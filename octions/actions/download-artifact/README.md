...
Original documentation: https://developer.github.com/v3/actions/artifacts/#download-an-artifact
...
```yaml
- uses: maxkomarychev/octions/octions/actions/download-artifact@master
  id: my_step_id
  with:
    token: <token value>
