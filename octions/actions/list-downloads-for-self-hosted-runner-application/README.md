...
Original documentation: https://developer.github.com/v3/actions/self_hosted_runners/#list-downloads-for-the-self-hosted-runner-application
...
```yaml
- uses: maxkomarychev/octions/octions/actions/list-downloads-for-self-hosted-runner-application@master
  id: my_step_id
  with:
    token: <token value>
- name: Print outputs
