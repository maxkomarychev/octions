...
Original documentation: https://developer.github.com/v3/actions/self-hosted-runners/#create-a-remove-token-for-a-repository
...
```yaml
- uses: maxkomarychev/octions/octions/actions/create-remove-token-for-repo@master
  id: my_step_id
  with:
    token: <token value>
- name: Print outputs
