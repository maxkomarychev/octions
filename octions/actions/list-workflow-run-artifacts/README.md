...
Original documentation: https://developer.github.com/v3/actions/artifacts/#list-workflow-run-artifacts
...
```yaml
- uses: maxkomarychev/octions/octions/actions/list-workflow-run-artifacts@master
  id: my_step_id
  with:
    token: <token value>
    run_id: <run_id value>
