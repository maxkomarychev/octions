...
Original documentation: https://developer.github.com/v3/actions/self_hosted_runners/#remove-a-self-hosted-runner
...
```yaml
- uses: maxkomarychev/octions/octions/actions/remove-self-hosted-runner@master
  id: my_step_id
  with:
    token: <token value>
