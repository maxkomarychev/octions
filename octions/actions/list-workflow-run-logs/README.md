...
Original documentation: https://developer.github.com/v3/actions/workflow_runs/#list-workflow-run-logs
...
```yaml
- uses: maxkomarychev/octions/octions/actions/list-workflow-run-logs@master
  id: my_step_id
  with:
    token: <token value>
    run_id: <run_id value>
