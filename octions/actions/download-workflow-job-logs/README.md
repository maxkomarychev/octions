...
Original documentation: https://developer.github.com/v3/actions/workflow-jobs/#download-workflow-job-logs
...
```yaml
- uses: maxkomarychev/octions/octions/actions/download-workflow-job-logs@master
  id: my_step_id
  with:
    token: <token value>
    job_id: <job_id value>
