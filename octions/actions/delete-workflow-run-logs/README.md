...
Original documentation: https://developer.github.com/v3/actions/workflow-runs/#delete-workflow-run-logs
...
```yaml
- uses: maxkomarychev/octions/octions/actions/delete-workflow-run-logs@master
  id: my_step_id
  with:
    token: <token value>
    run_id: <run_id value>
