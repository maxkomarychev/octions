...
Original documentation: https://developer.github.com/v3/actions/workflow_runs/#get-a-workflow-run
...
```yaml
- uses: maxkomarychev/octions/octions/actions/get-workflow-run@master
  id: my_step_id
  with:
    token: <token value>
    run_id: <run_id value>
