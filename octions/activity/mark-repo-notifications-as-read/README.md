...
Original documentation: https://developer.github.com/v3/activity/notifications/#mark-repository-notifications-as-read
...
```yaml
- uses: maxkomarychev/octions/octions/activity/mark-repo-notifications-as-read@master
  id: my_step_id
  with:
    token: <token value>
- name: Print outputs
