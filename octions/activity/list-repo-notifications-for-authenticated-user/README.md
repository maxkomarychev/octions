...
Original documentation: https://developer.github.com/v3/activity/notifications/#list-repository-notifications-for-the-authenticated-user
...
```yaml
- uses: maxkomarychev/octions/octions/activity/list-repo-notifications-for-authenticated-user@master
  id: my_step_id
  with:
    token: <token value>
    all: <all value>
