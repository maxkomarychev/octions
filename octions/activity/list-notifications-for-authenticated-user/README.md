...
Original documentation: https://developer.github.com/v3/activity/notifications/#list-notifications-for-the-authenticated-user
...
```yaml
- uses: maxkomarychev/octions/octions/activity/list-notifications-for-authenticated-user@master
  id: my_step_id
  with:
    token: <token value>
    all: <all value>
