...
Original documentation: https://developer.github.com/v3/issues/#list-user-account-issues-assigned-to-the-authenticated-user
...
```yaml
- uses: maxkomarychev/octions/octions/issues/list-for-authenticated-user@master
  id: my_step_id
  with:
    token: <token value>
    filter: <filter value>
