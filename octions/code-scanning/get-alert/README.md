...
Original documentation: https://developer.github.com/v3/code-scanning/#get-a-code-scanning-alert
...
```yaml
- uses: maxkomarychev/octions/octions/code-scanning/get-alert@master
  id: my_step_id
  with:
    token: <token value>
...
|alert_id|true|alert_id parameter
