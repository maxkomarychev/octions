...
Original documentation: https://developer.github.com/v3/teams/discussions/#get-a-single-discussion-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/get-discussion-legacy@master
  id: my_step_id
  with:
    token: <token value>
