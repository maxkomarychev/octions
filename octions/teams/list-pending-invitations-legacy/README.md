...
Original documentation: https://developer.github.com/v3/teams/members/#list-pending-team-invitations-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/list-pending-invitations-legacy@master
  id: my_step_id
  with:
    token: <token value>
