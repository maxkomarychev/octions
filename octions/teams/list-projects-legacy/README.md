...
Original documentation: https://developer.github.com/v3/teams/#list-team-projects-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/list-projects-legacy@master
  id: my_step_id
  with:
    token: <token value>
