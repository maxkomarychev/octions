...
Original documentation: https://developer.github.com/v3/teams/discussion_comments/#delete-a-comment-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/delete-discussion-comment-legacy@master
  id: my_step_id
  with:
    token: <token value>
