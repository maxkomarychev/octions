...
Original documentation: https://developer.github.com/v3/teams/members/#get-team-member-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/get-member-legacy@master
  id: my_step_id
  with:
    token: <token value>
