...
Original documentation: https://developer.github.com/v3/teams/discussions/#list-discussions-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/list-discussions-legacy@master
  id: my_step_id
  with:
    token: <token value>
