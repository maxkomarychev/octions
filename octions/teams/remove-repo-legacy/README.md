...
Original documentation: https://developer.github.com/v3/teams/#remove-team-repository-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/remove-repo-legacy@master
  id: my_step_id
  with:
    token: <token value>
