...
Original documentation: https://developer.github.com/v3/teams/members/#remove-team-membership-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/remove-membership-legacy@master
  id: my_step_id
  with:
    token: <token value>
