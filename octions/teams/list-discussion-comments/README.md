...
Original documentation: https://developer.github.com/v3/teams/discussion_comments/#list-comments

This action implements `GET` request to `/teams/{team_id}/discussions/{discussion_number}/comments`
