...
Original documentation: https://developer.github.com/v3/teams/#remove-team-project-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/remove-project-legacy@master
  id: my_step_id
  with:
    token: <token value>
