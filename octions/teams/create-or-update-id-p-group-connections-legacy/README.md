...
Original documentation: https://developer.github.com/v3/teams/team_sync/#create-or-update-idp-group-connections-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/create-or-update-id-p-group-connections-legacy@master
  id: my_step_id
  with:
    token: <token value>
