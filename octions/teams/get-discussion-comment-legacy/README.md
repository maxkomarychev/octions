...
Original documentation: https://developer.github.com/v3/teams/discussion_comments/#get-a-single-comment-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/get-discussion-comment-legacy@master
  id: my_step_id
  with:
    token: <token value>
