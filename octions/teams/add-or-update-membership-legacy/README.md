...
Original documentation: https://developer.github.com/v3/teams/members/#add-or-update-team-membership-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/add-or-update-membership-legacy@master
  id: my_step_id
  with:
    token: <token value>
