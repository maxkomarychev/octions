...
Original documentation: https://developer.github.com/v3/teams/discussions/#create-a-discussion-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/create-discussion-legacy@master
  id: my_step_id
  with:
    token: <token value>
