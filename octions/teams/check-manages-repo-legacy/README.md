...
Original documentation: https://developer.github.com/v3/teams/#check-if-a-team-manages-a-repository-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/check-manages-repo-legacy@master
  id: my_step_id
  with:
    token: <token value>
