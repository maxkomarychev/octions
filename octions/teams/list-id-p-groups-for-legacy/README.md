...
Original documentation: https://developer.github.com/v3/teams/team_sync/#list-idp-groups-for-a-team-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/list-id-p-groups-for-legacy@master
  id: my_step_id
  with:
    token: <token value>
