...
Original documentation: https://developer.github.com/v3/teams/members/#list-team-members-legacy
...
```yaml
- uses: maxkomarychev/octions/octions/teams/list-members-legacy@master
  id: my_step_id
  with:
    token: <token value>
